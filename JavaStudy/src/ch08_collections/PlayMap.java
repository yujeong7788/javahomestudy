...
public class PlayMap {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < playList.size(); i++) {
			String[] temp = playList.get(i).split(": "); // 문자열 배열로 리턴됨
			//temp[0] = 제목
			//temp[1] = 가수
...
//	public static ArrayList<String> searchMap(String option, String keyword, Set<String> keySet playMap){
//		// playList 내에 keyword를 포함하고 있는 데이터 찾기
//		for (int i = 0; i < playMap.size(); i++) {
//			String[] temp = playMap.get(i).split(":");
//			
//			if(option.equals("제목")) {
//				if(temp[0].contains(keyword)) {
//					result.add(playMap.get(i));
//				}
//			}else if(option.equals("가수")) {
