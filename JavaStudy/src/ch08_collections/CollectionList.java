...
public class CollectionList {
	...
	public static void main(String[] args) {
		...
		// 우리가 Wraaper 클래스를 사용하는데 불편함은 없다.
		...
		intList.add(2);
		intList.add(3);
		intList.add(4); // 데이터는 넣은 순서대로 차례차례 들어감
...
//		students.add(2); // 에러
		...
		System.out.println(students.indexOf("이자영"));
		System.out.println(students.indexOf("준호") != -1); // true
...
//		students.remove(30); // 에러
//		System.out.println(students);
		
		students.remove("백민기");
		System.out.println(students);

		students.remove("아무말"); // 값이 없으면 아무일도 일어나지 않는다.
		System.out.println(students);
		...
		// 값을 주면서 리스트 선언
		ArrayList<Integer> numbers = new ArrayList<>(Arrays.asList(20,34,11,5,2,3)) ;
