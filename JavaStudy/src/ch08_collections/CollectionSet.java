...
public class CollectionSet {
	...
	public static void main(String[] args) {
		...
		//주머니에 값을 담는 느낌이라 순서 없이 담김, 순서 보장X
		...
		while(iter.hasNext()) { // .hasNext 다음라인 데이터 있어? O -> true , X -> false
			String name = iter.next(); // 그 데이터 가져옴
		...
		intSet.addAll(intList); // 한번에 모든 값 옮겨짐
