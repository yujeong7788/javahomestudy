...
public class ApiStringBuffer {
	...
	public static void main(String[] args) {
		...
		//StringBuffer 객체 소환
		StringBuffer strBuff = new StringBuffer(); //  = (String text = "");
		
		System.out.println(strBuff);
		
		// append(문자열) 문자열을 추가
		strBuff.append("12");
//		strBuff.append(12); -- 숫자 넣어도 알아서 문자열로
		System.out.println(strBuff);
		...
		// 보유중인 문자열 비우기
		strBuff = new StringBuffer(); // 빈 문자열을 가지는 StringBuffer 객체 생성됨
